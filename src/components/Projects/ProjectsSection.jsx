...
export default function ProjectsSection() {
    const ProjectsData = [
        ...
        },
        {
            title: 'Vedic Store',
            tech: 'MERN Stack Project',
            description: "Vedic Store is an Ecommerce store which sells Authentic Hindu Scriptures and spiritual Products",
            img: '/assets/images/projects/vedicstore.png',
            link: 'https://vedicstore.vercel.app',
            github: 'https://github.com/developerkarann/Ultimate-Ecommerce',
        },
        {
